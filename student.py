...
class studentClass: 
    def __init__(self,root): # default constructor
        ...
        self.txt_gender=ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Male","Female","Othes"), font=("goudy old style",15,"bold"),state='readonly',justify=CENTER)
        ...
        lbl_admisssion=Label(self.root,text="Admission",font=("goudy old style",15,"bold"),bg="white").place(x=360,y=140)
        lbl_course=Label(self.root,text="Course",font=("goudy old style",15,"bold"),bg="white").place(x=360,y=180)

        #=====Entry Fields====for column2===========
        ...
        self.txt_address.place(x=150,y=275,width=500,height=100)
