...
class reportClass: 
    def __init__(self,root): # default constructor
        ...
        #==========clear Button==================
        btn_clear=Button(self.root,text="Clear",font=("goudy old style",15,"bold"),bg="gray",fg="white",cursor="hand2",command=self.clear).place(x=820,y=100,width=100,height=35)
        ...
        lbl_per=Label(self.root,text="Percentange",font=("goudy old style",15,"bold"),bg="White",bd=2,relief=GROOVE).place(x=900,y=230,width=150,height=50)

        #=============result Show in Result Columns=======================
